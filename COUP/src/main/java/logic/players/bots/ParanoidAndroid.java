...
public class ParanoidAndroid extends Player {

    private boolean paranoia = false;

    public ParanoidAndroid(String name, int playerNumber, Card card1, Card card2) {
    ...
    public void startCall() {
        ...
        if(this.hasCard(CardType.assassin) && coins >= 7){
            Card playThis;
            if(cards[0].getCardType() == CardType.assassin && !cards[0].isDead()) {
                playThis = cards[0];
            }else {
                playThis = cards[1];
            }
    ...
    public void challengeCall(Actions action) {
        ...
        if(paranoia){
            ...
            game.callBack(playerNumber, Actions.challenge, this.playerNumber, playThis);
    ...
    public void kill() {
        ...
        if (cards[0].isDead() || (!cards[0].isDead() && cards[1].getCardType() != CardType.contessa)) {
